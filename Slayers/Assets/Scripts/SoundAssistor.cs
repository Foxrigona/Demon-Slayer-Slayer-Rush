...
public class SoundAssistor : MonoBehaviour
{
    private int soundShards = 0;
    ...
    private void Awake()
    {
        ...
        GameObject.Find("Assist Shard Count").transform.GetComponent<TextMeshProUGUI>().SetText("Sound Shards: " + this.soundShards);
        GameObject.Find("Assist Shard Bar").GetComponent<ShardBar>().updateBar(this.soundShards);
    }
    ...
    {
        soundShards += shardCount;
        GameObject.Find("Assist Shard Count").transform.GetComponent<TextMeshProUGUI>().SetText("Sound Shards: " + this.soundShards);
        GameObject.Find("Assist Shard Bar").GetComponent<ShardBar>().updateBar(this.soundShards);
        if (this.soundShards >= this.requiredAttackShards) StartUlt();
    }
